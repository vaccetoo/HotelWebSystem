        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(525)", maxLength: 525, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(1025)", maxLength: 1025, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilitiesReservations", x => new { x.FacilityId, x.ReservationId });
                    table.ForeignKey(
                        name: "FK_FacilitiesReservations_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacilitiesReservations_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilitiesReservations_ReservationId",
                table: "FacilitiesReservations",
