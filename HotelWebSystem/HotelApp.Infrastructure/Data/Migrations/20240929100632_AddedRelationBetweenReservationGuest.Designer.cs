...
namespace HotelApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240929100632_AddedRelationBetweenReservationGuest")]
    partial class AddedRelationBetweenReservationGuest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.Facility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.FacilityReservation", b =>
                {
                    b.HasOne("HotelApp.Infrastructure.Data.Models.Facility", "Facility")
                        .WithMany("FacilityReservations")
                        .HasForeignKey("FacilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelApp.Infrastructure.Data.Models.Reservation", "Reservation")
                        .WithMany("FacilitiesReservation")
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.Reservation", b =>
                {
                    b.HasOne("HotelApp.Infrastructure.Data.Models.Room", "Room")
                        .WithMany("Reservations")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelApp.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.ReservationParticipant", b =>
                {
                    b.HasOne("HotelApp.Infrastructure.Data.Models.Guest", "Guest")
                        .WithMany("ReservationsParticipant")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelApp.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.Guest", b =>
                {
                    b.Navigation("ReservationsParticipant");
                });

            modelBuilder.Entity("HotelApp.Infrastructure.Data.Models.Reservation", b =>
                {
                    b.Navigation("FacilitiesReservation");
